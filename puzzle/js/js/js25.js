...
function get25RandomDiv(){
	...
	var selectDiv= allDiv[Math.floor(Math.random() * 44)];
	return selectDiv;
}	
	...
	$(this).css({'background-color': getColorSet()});
		...
		// opacityValue = opacityValue - 0.2;
  		...
  		// $(this).animate({opacity : opacityValue}, 300);
   		...
   		document.getElementById("show").innerHTML = get25RandomDiv();
   		$( "#" + get25RandomDiv() ).after( "<div class='test'></div>" );
